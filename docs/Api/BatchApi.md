...
```php
batchCities($batch_request, $lang, $fields): \GeoSearch\Model\CityListResponse
```
...
$apiInstance = new GeoSearch\Api\BatchApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$batch_request = {"ids":[5391959,5128581,4887398]}; // \GeoSearch\Model\BatchRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **batch_request** | [**\GeoSearch\Model\BatchRequest**](../Model/BatchRequest.md)|  | |
...
```php
batchCountries($batch_request, $lang, $fields): \GeoSearch\Model\CountryListResponse
```
...
$batch_request = {"ids":[6252001,2635167,2921044]}; // \GeoSearch\Model\BatchRequest
$lang = de; // string | ISO 639-1 language code for localized names (e.g., de, fr, ja)
$fields = name,population,iso_code; // string | Comma-separated list of fields to include in the response
...
```php
batchRegions($batch_request, $lang, $fields): \GeoSearch\Model\RegionListResponse
```
...
$batch_request = {"ids":[5332921,5128638,4862182]}; // \GeoSearch\Model\BatchRequest
$lang = de; // string | ISO 639-1 language code for localized names (e.g., de, fr, ja)
$fields = name,population,iso_code; // string | Comma-separated list of fields to include in the response
