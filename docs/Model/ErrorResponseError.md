...
**code** | **string** |  |
**message** | **string** |  |
**details** | [**\GeoAPI\Model\ErrorResponseErrorDetailsInner[]**](ErrorResponseErrorDetailsInner.md) |  | [optional]
...
**quota** | [**\GeoAPI\Model\QuotaDetail**](QuotaDetail.md) |  | [optional]
**upgrade** | [**\GeoAPI\Model\UpgradeDetail**](UpgradeDetail.md) |  | [optional]
