...
class HealthApi
{
     ...
     * @return \GeoSearch\Model\GetStatus200Response
     */
     ...
     * @throws \GeoSearch\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \GeoSearch\Model\GetStatus200Response, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\GeoSearch\Model\GetStatus200Response',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\GeoSearch\Model\GetStatus200Response';
        $request = $this->getStatusRequest($contentType);
