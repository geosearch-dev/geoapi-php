...
class HealthApi
{
     ...
     * @return \GeoAPI\Model\GetStatus200Response
     */
     ...
     * @throws \GeoAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \GeoAPI\Model\GetStatus200Response, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\GeoAPI\Model\GetStatus200Response',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\GeoAPI\Model\GetStatus200Response';
        $request = $this->getStatusRequest($contentType);
