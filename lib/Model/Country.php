...
class Country implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Gets geometry
     *
     * @return \GeoSearch\Model\GeoJSONMultiPolygon|null
     */
     ...
     * Sets geometry
     *
     * @param \GeoSearch\Model\GeoJSONMultiPolygon|null $geometry Country boundary. Returned by default on `GET /v1/countries/{code}` and on request via `?fields=geometry` on `GET /v1/countries`.  NOT TIER-GATED. Country geometry is served on every plan, including Free. Region geometry is gated — see the `Region` schema.
     *
     * @return self
     */
