...
class BatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['ids']) > 50)) {
            $invalidProperties[] = "invalid value for 'ids', number of items must be less than or equal to 50.";
        }
     ...
     * Sets ids
     *
     * @param int[] $ids Array of entity IDs to look up (max 50)
     *
     * @return self
     */
    public function setIds($ids)
    {
        ...
        if ((count($ids) > 50)) {
            throw new \InvalidArgumentException('invalid value for $ids when calling BatchRequest., number of items must be less than or equal to 50.');
        }
        if ((count($ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $ids when calling BatchRequest., number of items must be greater than or equal to 1.');
        }
