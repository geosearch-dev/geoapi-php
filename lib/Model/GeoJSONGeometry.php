 ...
 *
 * @category Class
 * @description A bare GeoJSON geometry — the &#x60;{\&quot;type\&quot;: ..., \&quot;coordinates\&quot;: ...}&#x60; object itself, NOT a GeoJSON &#x60;Feature&#x60;. There is no &#x60;properties&#x60; wrapper.
 * @package  GeoSearch
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class GeoJSONGeometry implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets type
     *
     * @param string $type `MultiPolygon` for most areas, `Polygon` for areas with a single ring — including areas that BECOME single-ring under `?simplify=`. Do not pin this to one value.
     *
     * @return self
     */
     ...
     * Sets coordinates
     *
     * @param mixed[] $coordinates Nesting depth depends on `type`: three levels for `Polygon`, four for `MultiPolygon`. Positions are `[longitude, latitude]` in EPSG:4326, per the GeoJSON specification.
     *
     * @return self
     */
